      ...
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="bg-[#111111] border border-neutral-800 rounded-2xl p-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M13.3 7.15c0-.5-.04-1-.12-1.47H7v2.78h3.53a3.02 3.02 0 01-1.31 1.98v1.65h2.12c1.24-1.14 1.96-2.82 1.96-4.94z" fill="#4285F4" />
                <path d="M7 13.5c1.77 0 3.26-.59 4.34-1.59l-2.12-1.65c-.59.4-1.34.63-2.22.63-1.7 0-3.15-1.15-3.66-2.7H1.16v1.7A6.5 6.5 0 007 13.5z" fill="#34A853" />
                <path d="M3.34 8.19A3.9 3.9 0 013.13 7c0-.41.07-.82.2-1.19V4.11H1.16A6.5 6.5 0 00.5 7c0 1.05.25 2.04.66 2.89l2.18-1.7z" fill="#FBBC05" />
                <path d="M7 3.1c.96 0 1.82.33 2.5.97l1.87-1.87A6.45 6.45 0 007 .5 6.5 6.5 0 001.16 4.11l2.18 1.7C3.85 4.25 5.3 3.1 7 3.1z" fill="#EA4335" />
              </svg>
            ...
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M7 0.5C3.41 0.5.5 3.41.5 7c0 2.88 1.87 5.32 4.47 6.18.33.06.45-.14.45-.31v-1.1c-1.82.4-2.2-.88-2.2-.88-.3-.76-.73-1-.73-1-.6-.4.04-.4.04-.4.66.05 1 .68 1 .68.59 1 1.54.71 1.91.54.06-.42.23-.71.42-.87-1.45-.16-2.98-.73-2.98-3.23 0-.71.25-1.3.68-1.75-.07-.17-.3-.83.06-1.73 0 0 .56-.18 1.83.68A6.37 6.37 0 017 3.73c.57 0 1.14.08 1.67.23 1.27-.86 1.83-.68 1.83-.68.36.9.13 1.56.06 1.73.42.45.68 1.04.68 1.75 0 2.5-1.53 3.07-2.99 3.23.24.2.45.6.45 1.21v1.8c0 .17.12.37.45.31C11.63 12.32 13.5 9.88 13.5 7c0-3.59-2.91-6.5-6.5-6.5z" fill="currentColor" />
              </svg>
