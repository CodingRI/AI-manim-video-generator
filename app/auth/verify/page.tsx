...
// 2. Create a parent component that wraps the inner component in Suspense
export default function VerifyPage() {
  return (
    ...
    >
      <Suspense fallback={<div className="text-neutral-400 text-sm">Loading verification...</div>}>
        <VerifyContent />
      </Suspense>
    </main>
  );
